...
def get_customer():
    f = open('username.txt')
    customer_id = f.readline()
    if isinstance(customer_id, tuple) or isinstance(customer_id, list):
...
listbox = None
button_ = None
show_dress_button, book_dress_button, show_booking_button, user_screen, welcomeLabel = None, None, None, None, None


def reset_variable():
    global label_one, label_two, input_2, input_1, listbox, label_three, input_3, label_four, input_4, button_
    global show_dress_button, book_dress_button, show_booking_button, welcomeLabel
    all_element = [button_, label_one, label_two, welcomeLabel, input_2, input_1, listbox, label_three, input_3,
                   label_four, input_4, show_dress_button, book_dress_button, show_booking_button]
...
def book_dress_():
    ...
    success, msg = book_db.book_dress(
    ...
    label_one = Label(user_screen, text=msg, bg="black", fg="white", font=('Helvetica', 16, 'bold'))
...
def book_dress():
    global label_one, label_two, input_2, input_1, label_three, input_3, button_, user_screen
    reset_variable()
...
def run_user_screen():
    global show_dress_button, book_dress_button, show_booking_button, user_screen, button_, welcomeLabel
    reset_variable()
    username = customer_db.get_user(get_customer())
    welcomeLabel = Label(text=f"Welcome {username}", bg='white', fg="black",
                         font=('Helvetica', 16, 'bold'))
    welcomeLabel.place(relx=0.51, rely=0.03, anchor='nw')
